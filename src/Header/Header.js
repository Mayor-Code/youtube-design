...
export default function Header() {
  return (
    <div className="header d-flex justify-content-space-between align-items-center">
      ...
      <div className="header-middle-items d-flex align-items-center justify-content-center">
        <div className="input-box d-flex align-items-center">
          <div className="d-flex align-items-center search-icon hidden">
            <IoSearchOutline
              style={{
                width: "1.2rem",
                height: "auto",
          ...
          <input
            ...
            onBlur={blur}
          />
          <div className="d-flex align-items-center justify-content-center search-btn pointer">
            <IoSearchOutline
              style={{
                width: "1.4rem",
                height: "auto",
        ...
        <div className="voice-search d-flex align-items-center justify-content-center pointer">
          <MdKeyboardVoice style={{ width: "1.5rem", height: "auto" }} />
        </div>
      </div>
      <div className="header-right-items d-flex align-items-center">
        <div className="create-options d-flex align-items-center justify-content-center pointer">
          <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
            focusable="false"
          ...
          >
            <g class="style-scope yt-icon">
              <path
                d="M14,13h-3v3H9v-3H6v-2h3V8h2v3h3V13z M17,6H3v12h14v-6.39l4,
                1.83V8.56l-4,1.83V6 M18,5v3.83L22,7v8l-4-1.83V19H2V5H18L18,5 z"
                class="style-scope yt-icon"
              ></path>
            </g>
          </svg>
        </div>
        <div className="notifications  d-flex align-items-center justify-content-center pointer">
        ...
        <div className="profile-menu">
          <div className="profile-img d-flex align-items-center justify-content-center pointer">
            <img src={require("../images/user.png")} alt="" className="dp" />
          </div>
        </div>
      </div>
    </div>
